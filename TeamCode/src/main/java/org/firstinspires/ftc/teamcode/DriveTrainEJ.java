...
public class DriveTrainEJ {
    ...
    public static DriveTrainEJ initDriveTrain(HardwareMap hardwareMap) {
        //Hardware mapping the motors:
        DriveTrainEJ driveTrain = new DriveTrainEJ();
    ...
    public static void logTelemetry(Telemetry telemetry, DriveTrainEJ driveTrain) {
