...
public class VuforiaNavigator extends RobotComponent {
    private static final float mmPerInch        = 25.4f;
    private static final float mmFTCFieldWidth  = 32 * mmPerInch;
    private static final float mmTargetHeight   = 1 * mmPerInch;
    ...
    public void init(HardwareMap hardwareMap) {
        VuforiaLocalizer vuforia = ComplexSensorFactory.getVuforiaInstance(hardwareMap, true);
        ...
        CameraName webcam = hardwareMap.get(WebcamName.class, HardwareMapConstants.CAMERA);

        for (VuforiaTrackable trackable : allTrackables)
        {
            ((VuforiaTrackableDefaultListener)trackable.getListener()).setCameraLocationOnRobot(webcam, cameraLocationOnRobot);
        }
